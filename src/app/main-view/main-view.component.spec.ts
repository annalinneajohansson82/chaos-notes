...
describe('MainViewComponent', () => {
  ...
  // --- Braindump section now uses app-task-item (PR change) ---
  ...
  // --- completeTask called via (complete) event for braindump notes ---
  ...
  // --- soonLabel getter uses getFuzzyLabel ---
  ...
  // --- showNowNudge uses nowSoftLimit ---

  it('showNowNudge is false when now count is at the soft limit', () => {
    const fixture = TestBed.createComponent(MainViewComponent);
    // DEFAULT_SETTINGS.nowSoftLimit === 5
